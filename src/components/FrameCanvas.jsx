    ...
    img.onload = () => {
      ...
      const prepareCanvas = (userLogoImg, detectedLogoImg) => {
        ...
        if (template.name === 'live_view_style') {
          ...
          // EV Metering simulation (usually around the middle)
          let evText = "MM ★";
          ...
          // Draw AF mode and Metering at bottom right
          ctx.textAlign = 'right';
          ctx.fillText(`AF-S   ${evText}`, imgWidth - padding, textY);
          
          ctx.restore();          // 5. Draw Real Histogram
          ctx.save();
          try {
