...
export default function DoublePrintPage({ isDarkMode }) {
  ...
  }, [printerProfile, customNames, customDate, fontFamily, showDashedLine]);
  ...
  const handleFilesInput = useCallback(async (files) => {
    ...
    try {
      ...
      setImageZoom(80); // reset zoom on new photo
      setImageOffsetX(0);
      setImageOffsetY(0);
        ...
        <div className="yearbook-layout-wrapper">
          <aside className="yearbook-sidebar">
            <div className="panel-box">
              ...
              <div className="yearbook-sidebar-controls" style={{ flex: 1 }}>
                {renderLayoutPanel()}
                {renderTextPanel()}
                {renderStylePanel()}
